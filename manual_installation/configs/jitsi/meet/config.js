...
var config = {
    ...
    hosts: {
        ...
        muc: 'conference.<!--# echo var="subdomain" default="" -->{{ HOSTNAME }}'
    },
    ...
    // Websocket URL
    // websocket: 'wss://{{ HOSTNAME }}/xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.{{ HOSTNAME }}',
    ...
    //     // by default uses:
    //     // 'https://{{ HOSTNAME }}/static/oauth.html'
    //     redirectURI:
    //          'https://{{ HOSTNAME }}/subfolder/static/oauth.html'
    // },
...
//defaultLanguage: 'de'
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.{{ HOSTNAME }}',
